...
// 소멸 (Unmounting) 단계 - 이 컴포넌트가 화면에서 완전히 파괴되어 사라질 때 실행된다.
onUnmounted(() => {
...
<template>
  <div class="practice-section">
    <h2>Lifecycle Hook 실습</h2>
    <p>3초마다 자동으로 숫자가 카운트됩니다: {{ count }}</p>
    <small style="color: gray">(브라우저 콘솔 F12를 열어서 로그를 확인하세요)</small>
  </div>
</template>
